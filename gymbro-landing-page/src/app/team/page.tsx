                ...
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                    <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
                        ...
                        <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">
                            En Gymbro, nuestro equipo de desarrollo está compuesto por profesionales apasionados y altamente capacitados que trabajan arduamente para hacer realidad nuestra visión de una experiencia fitness sin complicaciones y centrada en el usuario.
                        </p>
                    </div>
                    <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
                        <div className="text-center text-gray-500 dark:text-gray-400">
                            <Image className='mx-auto mb-4 w-36 h-36 rounded-full' src="/assets/img/profiles/Chris.jpg" alt="Christan Alexander Vazquez Gonzales" width={1000} height={1000} />
                            <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="#">Christan Alexander Vazquez Gonzales</a>
                            </h3>
                            <p>SEO & Fullstack Developer</p>
                        ...
                        <div className="text-center text-gray-500 dark:text-gray-400">
                            <Image className='mx-auto mb-4 w-36 h-36 rounded-full' src="/assets/img/profiles/Isai.jpg" alt="Jesus Isaí Vazquez Valdez" width={1000} height={1000} />
                            <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="#">Jesus Isaí Vazquez Valdez</a>
                            </h3>
                            <p>Móvil Developer</p>
                            <ul className="flex justify-center mt-4 space-x-4">
                                <li>
                        ...
                        <div className="text-center text-gray-500 dark:text-gray-400">
                            <Image className='mx-auto mb-4 w-36 h-36 rounded-full' src="/assets/img/profiles/Hazael.jpg" alt="Hazael Abiran Poot May" width={1000} height={1000} />
                            <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="#">Hazael Abiran Poot May</a>
                            </h3>
